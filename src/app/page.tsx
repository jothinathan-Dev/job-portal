...
import { Sparkles, TrendingUp, Building2, MapPin, Zap, CheckCircle2, ShieldCheck, Clock } from 'lucide-react';
import initialJobs from '@/data/jobs.json';
import { JobListing } from '@/lib/types';

export default function HomePage() {
  const [jobs] = useState<JobListing[]>(initialJobs as unknown as JobListing[]);
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs text-slate-500 font-medium">
              Updated Hourly • Verified Official Links
            </span>
          </div>
        ...
        {/* Informational Authority & Value Section (Crucial for AdSense approval) */}
        <section className="my-14 bg-white rounded-3xl p-6 sm:p-8 md:p-10 border border-slate-200/90 shadow-sm">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-heading mb-3">
              Why Job Seekers Rely On CommonJobs?
            </h2>
